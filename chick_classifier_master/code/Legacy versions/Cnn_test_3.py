...
model = Sequential()
#Convolution
model.add(Conv2D(32, (5, 5), activation ='relu', kernel_regularizer=regularizers.l2(0.01),  input_shape=(img_rows, img_cols, 1)))
...
model.add(Conv2D(512, (5, 5), activation ='relu',  input_shape=(img_rows, img_cols, 1)))
model.add(Dropout(0.3))
model.add(MaxPooling2D(pool_size=(2, 2)))
...
#
model.save('/Users/Ian_b/Downloads/Cnn2_30_epochs_08.02_C_.h5')  # creates a HDF5 file 'my_model.h5'
